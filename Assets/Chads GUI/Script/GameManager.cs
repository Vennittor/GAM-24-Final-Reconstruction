...
public class GameManager : MonoBehaviour 
{
	...
	void Start () 
	{
		...
		livesCount = playerDataHolder.GetComponent<DataHolder> ().livesCount;
	...
	void InitialSpawn ()
	{
		...
		{
			playerTwo = Instantiate (characters[8],pOneSpawn.transform.position,pOneSpawn.transform.rotation) as GameObject;
			playerTwo.name = "PlayerTwo";
			if (pTwoIsPlayer == true)
			{
		...
		{
			playerTwo = Instantiate (characters[9],pOneSpawn.transform.position,pOneSpawn.transform.rotation) as GameObject;
			playerTwo.name = "PlayerTwo";
			if (pTwoIsPlayer == true)
			{
		...
		if (playerCount > 2)
		{
			...
			{
				playerThree = Instantiate (characters[8],pOneSpawn.transform.position,pOneSpawn.transform.rotation) as GameObject;
				playerThree.name = "PlayerThree";
				if (pOneIsPlayer == true)
				{
			...
			{
				playerThree = Instantiate (characters[9],pOneSpawn.transform.position,pOneSpawn.transform.rotation) as GameObject;
				playerThree.name = "PlayerThree";
				if (pThreeIsPlayer == true)
				{
		...
		if (playerCount > 3) 
		{
			...
			{
				playerFour = Instantiate (characters[8],pOneSpawn.transform.position,pOneSpawn.transform.rotation) as GameObject;
				playerFour.name = "PlayerFour";
				if (pFourIsPlayer == true)
				{
			...
			{
				playerFour = Instantiate (characters[9],pOneSpawn.transform.position,pOneSpawn.transform.rotation) as GameObject;
				playerFour.name = "PlayerFour";
				if (pFourIsPlayer == true)
				{
