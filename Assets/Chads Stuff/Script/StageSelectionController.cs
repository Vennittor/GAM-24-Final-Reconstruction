...
//	BUTTONS
	...
	{
		stageDataHolder.GetComponent<DataHolder> ().stageSelection = DataHolder.StageSelect.yoshiIsland;
	...
	{
		stageDataHolder.GetComponent<DataHolder> ().stageSelection = DataHolder.StageSelect.frigateOrpheon;
